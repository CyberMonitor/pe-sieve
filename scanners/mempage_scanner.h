...
public:
	MemPageScanner(HANDLE _procHndl, MemPageData &_memPageDatal, bool detect_shellcode)
		: processHandle(_procHndl), memPage(_memPageDatal), detectShellcode(detect_shellcode),
		isDeepScan(true)
	{
	}
